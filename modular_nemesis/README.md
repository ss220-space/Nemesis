...
Те же правила относятся к helper-функциям и глобальным переменным — их соответствующие папки это **`code/__HELPERS/~nemesis_helpers`**
и **`code/_globalvars/~nemesis_globalvars`**
